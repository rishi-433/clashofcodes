...
import { Plus, Edit, Trash2, Home, RefreshCw, Zap,Video, Users } from 'lucide-react';
  ...
  const adminOptions = [
    {
      id: 'users',
      title: 'Manage Users',
      description: 'View, edit roles, or delete users',
      icon: Users,
      color: 'btn-info',
      bgColor: 'bg-info/10',
    ...
    },
    {
      ...
      color: 'btn-success',
      bgColor: 'bg-success/10',
      route: `${basePath}/video`
    },
    {
      id: 'create_contest',
      title: 'Create Contest',
      description: 'Host a new contest and select problems',
      icon: Zap,
      color: 'btn-primary',
      bgColor: 'bg-primary/10',
      route: `${basePath}/contest/create`
    }
  ];

  const filteredOptions = adminOptions.filter(option => {
    if (user?.role !== 'admin') {
      if (option.id === 'users') return false;
    }
    return true;
  });
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-base-content mb-4">
            {user?.role === 'admin' ? 'Admin Panel' : 'Host Panel'}
          </h1>
